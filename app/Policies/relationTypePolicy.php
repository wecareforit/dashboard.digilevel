...
class relationTypePolicy
{
    ...
    {
        return $user->can('view_any_relation::type');
    }
    ...
    {
        return $user->can('create_relation::type');
    }
    ...
    {
        return $user->can('delete_any_relation::type');
    }
    ...
    {
        return $user->can('force_delete_any_relation::type');
    }
    ...
    {
        return $user->can('restore_any_relation::type');
    }
    ...
    {
        return $user->can('reorder_relation::type');
    }
}
