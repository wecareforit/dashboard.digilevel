...
use App\Filament\Clusters\ToolsSettings\Resources\ToolsInspectionCompaniesResource\Pages;
use App\Filament\Clusters\ToolsSettings\Resources\ToolsInspectionCompaniesResource\RelationManagers;
...
class ToolsInspectionCompaniesResource extends Resource
{
    protected static ?string $model = ToolsInspectionCompany::class;
            ...
            Tables\Columns\Layout\Split::make([
                ...
                Tables\Columns\Layout\Stack::make([
                    ...
                    Tables\Columns\TextColumn::make('zipcode')->state(
                        function (ToolsInspectionCompany $rec) {
    ...
    {
        return [
            'index' => Pages\ManageToolsInspectionCompanies::route('/'),
        ];
    }
}