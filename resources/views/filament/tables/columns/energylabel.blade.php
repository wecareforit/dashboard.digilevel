...
<div>
    <div class="energy-class">
        @if($getRecord()->energy_label=='A')
            <div class="a"></div>
        @elseif($getRecord()->energy_label=='B')
            <div class="b"></div>
        @elseif($getRecord()->energy_label=='C')
            <div class="c"></div>
        @elseif($getRecord()->energy_label=='D')
            <div class="d"></div>
        @elseif($getRecord()->energy_label=='E')
            <div class="e"></div>
        @elseif($getRecord()->energy_label=='F')
            <div class="f"></div>
        @elseif($getRecord()->energy_label=='G')
            <div class="g"></div>
        @else
